...
<div class="container">
        ...
        <tbody id="appointmentData">
            <?php while ($row = $resultApproved->fetch_assoc()): ?>
                <tr>
                    ...
                    <td>
                        <a href="../MedRec/view_dental.php?appointment_id=<?php echo $row['appointment_id']; ?>&source=denmed">View Record</a>
                        <a href="../MedRec/create_dentrec.php?appointment_id=<?php echo $row['appointment_id']; ?>">Create Record</a>
    ...
    <?php while ($row = $resultCompleted->fetch_assoc()): ?>
        <tr>
            ...
            <td>
                <a href="../MedRec/view_dental.php?appointment_id=<?php echo $row['appointment_id']; ?>&source=denmed">View Record</a>
                <a href="../MedRec/update_dentrec.php?appointment_id=<?php echo $row['appointment_id']; ?>">Update Record</a>
            </td>
        </tr>
    <?php endwhile; ?>
</tbody>
    ...
    button.addEventListener("click", function() {
        ...
        .then(result => {
            if (result.trim() === "success") {
                ...
                row.cells[5].innerHTML = `<a href="../MedRec/view_dental.php?appointment_id=${appointment_id}&source=denmed">View Record</a>`; // Remove the complete button
