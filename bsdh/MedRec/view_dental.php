...
$query = "SELECT * FROM medical_records WHERE appointment_id = ? AND appointment_type = 'Dental'";
...
<div class="container">
    ...
    <?php else: ?>
        <p style="color: red; font-weight: bold;">No dental record found.</p>
        <a href="create_dentrec.php?appointment_id=<?php echo $appointment_id; ?>" class="create-button">Create Record</a>
    <?php endif; ?>

    <a href="denmed.php" class="back-button">Back to Dashboard</a>
</div>
